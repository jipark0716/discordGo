...
type Event struct {
    ...
    OnMessageCreate    func(data map[string]interface{}, soket gowebsocket.Socket)
}
...
func (this *Event) onTextMessageEvent(message string, socket gowebsocket.Socket) {
        ...
        switch t {
            ...
            case "MESSAGE_CREATE":
                if this.OnMessageCreate != nil {
                    this.OnMessageCreate(data, socket)
                }
        }
